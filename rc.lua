...
beautiful.init(awful.util.getdir("config") .. "themes/powerarrow-dark/theme.lua")
...
myawesomemenu = {
   ...
   { "lock", function() awesome.spawn("light-locker-command -l") end},
   { "power", function() awesome.spawn("xfce4-session-logout") end } 
}
...
beautiful.fs = lain.widget.fs({
    ...
    settings = function()
        widget:set_markup(markup.font(beautiful.font, " " .. fs_now.used .. "% "))
    end
})
...
--cals the function within the beautiful to put the arrows up
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.background(beautiful.fs.widget, beautiful.bg_focus),
            arrl_dl,
            baticon,
            bat.widget,
            arrl_ld,
