...
local myawesomemenu = {
    ...
    { "lock", function() os.execute(scrlocker) end},
    { "power", function() os.execute("xfce4-session-logout") end } 
}
...
globalkeys = my_table.join(
    ...
    awful.key({}, "#107", 
        function () 
            os.execute("scrot -e 'mv $f ~/screenshots/ 2>/dev/null'")
        end,
